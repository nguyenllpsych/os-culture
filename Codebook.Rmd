...
library("rio") #import export files
...
```{r codebook}
codebook_data <- data %>% #select variables for display
  select(age, gender_f, race_f, continent, career, career_o, lead, culture, politics, c19stress, group, #demographics
         agree, consci, extra, neuro, open, #personality
         selfQRP, peerQRP, opinionQRP, #QRP
         awarePRRP, selfPRRP, peerPRRP, recentPRRP, opinionPRRP, prrp1_5, prrp2_5, prrp3_5, #PRRP
         prrp1_5_o, prrp2_5_o, prrp3_5_o, #PRRP qual data
         participate, comfort, positive, negative, entity,
         repConf, integrity, intMild, intSerious, rep_2, rep_2_o,
         beh_1, beh_2, beh_3, 
         barrier, barrier_o, opportunity, opportunity_o,
         engagemotiv01:engagemotiv03, engagebarrier01:engagebarrier03, #qual data
         convomotiv01:convomotiv03, convoconcern01:convoconcern03, #qual data
         attcheck, experience_19, #attention checks
         
         ##items that have already been included in above scales
         ## + qualitative items
         qrp1_1:qrp5_3, qrp5_4:prrp1_4, prrp1_6:prrp2_4,prrp2_6:prrp3_4,prrp3_6:rep_1_4,
         int_1_1:experience_19, entity_1:entity_2, tipi_1:tipi_10, 
         lead_1:lead_3, prrp1_5_1:prrp1_5_10, prrp2_5_1:prrp2_5_9, prrp3_5_1:prrp3_5_6, rep_2_1:rep_2_9, lead_1:lead_3)

metadata(codebook_data)$name <- "OS Culture Codebook"
metadata(codebook_data)$description <- "Codebook: Open science practices in ethnic minority and cultural psychology"
metadata(codebook_data)$temporalCoverage <- "Winter 2020" 
